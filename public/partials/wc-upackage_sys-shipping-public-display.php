...
function display_shipping_select_city($citys)
{
  $current_r = WC()->customer->get_shipping_city();
?>
<p class="form-row form-row-wide" id="calc_shipping_city_field">
<span>
      <select name="calc_shipping_city"  rel="calc_shipping_city" class="city_select" id="calc_shipping_city" data-placeholder="<?php esc_attr_e( 'Town/ City', 'woocommerce' ); ?>">
